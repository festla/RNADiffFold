...
dataset_choices = ['RNAStrAlign', 'archiveII', 'bpRNA', 'bpRNAnew', 'PDB_TS1', 'PDB_TS11', 'PDB_TS2','PDB_TS3', 'PDB_VL1', 'TS_hard']
DATA_ROOT_PATH = '/storage/student2/xiao/lql/RNADiffFold/data/'
...
def parse_config(json_file):
    with open(join(HOME_PATH, 'evaluation', json_file), 'r') as f:
...
def get_data_test(args, alphabet):
    ...
    elif args.dataset == 'PDB_TS11':
        test = Dataset([join(DATA_ROOT_PATH, 'pdbnew', 'TS11')])
    elif args.dataset == 'PDB_TS2':
        test = Dataset([join(DATA_ROOT_PATH, 'pdbnew', 'TS2')])
    elif args.dataset == 'PDB_TS3':
        test = Dataset([join(DATA_ROOT_PATH, 'pdbnew', 'TS3')])
    elif args.dataset == 'PDB_VL1':
        test = Dataset([join(DATA_ROOT_PATH, 'pdbnew', 'VL1')])
